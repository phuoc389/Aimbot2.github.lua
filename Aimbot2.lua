...
local noclipEnabled = false -- NoClip bật/tắt
local fov = 100
...
local function getClosestPlayerInFOV(trg_part)
    ...
    for _, player in ipairs(Players:GetPlayers()) do
        if player ~= localPlayer and player.Name ~= "MunimNotFound" then
...
noclipBtn.MouseButton1Click:Connect(function()
    ...
    noclipBtn.Text = "NoClip: " .. (noclipEnabled and "Bật" or "Tắt")
end)
...
toggleMenuBtn.MouseButton1Click:Connect(function()
    ...
    jumpBtn.Visible = menuVisible
    noclipBtn.Visible = menuVisible
end)
